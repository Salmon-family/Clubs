package com.thechance.identity.ui.screen.signup.username
...
fun SignUpUserNameScreen(
    ...
    SignUpBirthdateAndGanderContent(
        state,
        onClickBirthdateAndGenderScreen = { navController.navigateToBirthdateAndGander() },
...
private fun SignUpBirthdateAndGanderContent(
    state: UserUIState,
    onClickBirthdateAndGenderScreen: () -> Unit,
    onClickBack: () -> Unit,
