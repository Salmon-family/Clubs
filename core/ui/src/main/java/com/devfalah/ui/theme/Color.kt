...
val LightCardBackgroundColor = Color(0xFFF6F6F7)
val LightPrimaryBlackColor = Color(0xFF04030A)
val LightSecondaryBlackColor = Color(0x9904030A)
val LightTernaryBlackColor = Color(0xFF000000)
...
val TernaryBlackColor = Color(0x6104030A)
val TernaryWhiteColor = Color(0x61FFFFFF)