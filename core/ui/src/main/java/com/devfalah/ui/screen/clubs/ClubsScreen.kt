    ...
    backgroundColor = Color(0xFFFAFAFA)
        ...
        Column() {
            ...
            Column(modifier = Modifier
                ...
                Text(text = "The Chance Community",
                    style = Typography.subtitle2,
                    color = LightSecondaryBlackColor)

                Text(text = "10K member . 100K post",
                    style = Typography.caption,
                    color = LightTernaryBlackColor)

                HeightSpacer8()

                Text(text = "This club is for the community of The Chance, to make discussions about Android development, an...",
                    style = Typography.caption,
                    color = LightSecondaryBlackColor)
