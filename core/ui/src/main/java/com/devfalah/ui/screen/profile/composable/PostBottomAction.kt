...
fun PostBottomAction(
    ...
    val threadWasSaved = stringResource(R.string.thread_has_been_saved)
    val threadWasUnsaved = stringResource(R.string.thread_has_been_unsaved)
        ...
        Box(modifier = Modifier.weight(1f), contentAlignment = Alignment.CenterEnd) {
            PostActionIcon(
                ...
                onClick = {
                    ...
                    showToastMessage(
                        context,
                        if (post.isSaved) threadWasSaved else threadWasUnsaved
                    )
                }
            )
        }
